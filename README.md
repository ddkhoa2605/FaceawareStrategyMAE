...
```bibtex
@article{do2026faceaware,
  title   = {Face-Aware Pretraining Strategy for Masked Autoencoders},
  author  = {Đỗ Đăng Khoa},
  year    = {2026},
  school  = {FPT University},
  note    = {DSP391m Final Report}
}
```
...
<div align="center">
Made with ❤️ at FPT University · Spring 2026 · DSP391m
</div>
